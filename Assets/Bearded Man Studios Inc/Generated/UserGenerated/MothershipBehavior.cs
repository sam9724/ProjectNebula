...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class MothershipBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (MothershipNetworkObject)obj;
		...
		{
			Initialize(new MothershipNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new MothershipNetworkObject(networker, this, createCode, metadata);
		}
