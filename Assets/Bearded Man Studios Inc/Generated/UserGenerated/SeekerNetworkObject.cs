...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class SeekerNetworkObject : NetworkObject
	{
		...
		public SeekerNetworkObject() : base() { Initialize(); }
		public SeekerNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public SeekerNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
